...
const ProjectCard = ({
  ...
  return (
    <motion.div
      className={`relative z-10 h-[550px] w-full bg-cover bg-center bg-no-repeat py-0 sm:h-[700px] md:h-[650px] lg:h-[500px]`}
      initial="initial"
      animate="animate"
    >
      <Container
      ...
      >
          ...
          {available ? (
            <>
              <Link
                ...
                target="_blank"
                aria-label="Open GitHub Repository"
                className="w-[43px] rounded-full bg-white p-3 text-[20px] md:p-5 lg:w-[65px]"
              >
                <SiAiohttp />
              </Link>
              <Link
        ...
        <div
          className={`absolute text-white ${
            !(id % 2 === 0)
              ? "right-0 top-32 mr-0 ml-10 md:right-0 lg:top-60 lg:mr-4"
              : "left-10 top-32 ml-0 lg:top-52 lg:ml-4"
          }`}
        >
          <AnimatedTitle
            text={name}
